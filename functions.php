...
function hello_theme_scripts_styles() { 
    ...
    wp_enqueue_style( 'hello-theme-pricing-css', get_stylesheet_directory_uri() . '/assets/css/hello-theme-pricing-table.css', [],HELLO_THEME_VERSION );
    wp_enqueue_script( 'hello-theme-pricing-js', get_stylesheet_directory_uri() . '/assets/js/hello-theme-pricing-table.js', [],HELLO_THEME_VERSION, true );
}
