  ...
  $(document).ready(function () {
    ...
    function updateAddonsSelection() {
      ...
      if (selectedCategory === "base-camp") {
        ...
        addonsSelection.innerHTML = `
                    <li><input type="checkbox" class="input-checkbox" name="addons" id="peak_active_days" value="peak_active_days"/><label for="peak_active_days" class="">Payout Schedule: bi-weekly: + 20% fee</label><span class="hello-theme-pcs-label-tooltips" data-tippy-content="Standard: 1st 21 days, then 14 days"><i aria-hidden="true" class="fas fa-info-circle"></i></span></li>
