...
function hello_theme_enqueue_product_selection() {
    $enabled_product_selection = get_option('enable_product_selection_pages');
    if ($enabled_product_selection === '1') {
        wp_enqueue_style( 'hello-theme-products-selection-challenge-css', get_stylesheet_directory_uri() . '/assets/css/hello-theme-product-selection.css', array(), null, 'all' );
