...
add_filter('woocommerce_countries', 'hello_theme_additional_add_kosovo');
function hello_theme_additional_add_kosovo($countries) {
    if (!isset($countries['XK'])) {
        $countries['XK'] = __('Kosovo', 'woocommerce');
    }
    return $countries;
}

add_filter('woocommerce_continents', 'hello_theme_additional_add_kosovo_to_continents');
function hello_theme_additional_add_kosovo_to_continents($continents) {
    if (!in_array('XK', $continents['EU']['countries'])) {
        $continents['EU']['countries'][] = 'XK';
    }
    return $continents;
}

add_filter('woocommerce_states', 'hello_theme_additional_add_kosovo_states');
function hello_theme_additional_add_kosovo_states($states) {
    if (!isset($states['XK'])) {
        $states['XK'] = array(
            '' => __('Your State Name', 'woocommerce'),
