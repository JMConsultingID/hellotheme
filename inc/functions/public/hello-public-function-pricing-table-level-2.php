...
function hello_pricing_table_level_2_shortcode($atts)
{
    ...
    ?>
    <div
        class="hello-theme-container hello-theme-table-pricing hello-theme-with-tab hello-theme-table-<?php echo $tab_mode; ?>">
        <div class="hello-theme-tab-buttons">
            <?php foreach ($categories as $index => $category): ?>
                <div class="hello-theme-tab-button <?php echo $index == 0 ? 'active' : ''; ?>"
                    data-tab-id="tab-<?php echo $category->term_id; ?>">
                ...
                if ($products): ?>
                    <div class="hello-theme-sub-tab-buttons">
                        <?php foreach ($products as $productIndex => $product): ?>
                            <div class="hello-theme-sub-tab-button <?php echo $productIndex == 0 ? 'active' : ''; ?>"
                                data-sub-tab-id="subtab-<?php echo $product->get_id(); ?>">
                    ...
                    <?php foreach ($products as $productIndex => $product): ?>
                        <div id="subtab-<?php echo $product->get_id(); ?>"
                            class="hello-theme-sub-tab-content product-<?php echo $product->get_slug(); ?> <?php echo $productIndex == 0 ? 'active' : ''; ?>"
                            data-sub-tab-id="subtab-<?php echo $product->get_id(); ?>">
                            ...
                            $acf_levels = array(
                                ...
                                'level_4' => 'hello_pricing_plan_step_4',
                            );
                                            ...
                                            if (!is_null($sample_fields) && is_array($sample_fields)):
                                                ...
                                                foreach ($sample_fields as $field_key => $field_value):
                                                    ...
                                                    if ($field_object):
                                                        ...
                                                        <div
                                                            class="hello-theme-pricing-table-row pt__row label-<?php echo esc_html($field_key); ?>">
                                                            <?php
                                                            ...
                                                            <?php if ($tooltips === 'yes' && !empty($tooltip_field_values[$field_key])): ?>
                                                                <span class="hello-theme-label-tooltips"
                                                                    data-tippy-content="<?php echo esc_html($tooltip_field_values[$field_key]); ?>">
                                        ...
                                        <div class="hello-theme-pricing-table-option pt__option__slider swiper" id="pricingTableSlider">
                                            <div class="swiper-wrapper">
                                                ...
                                                <?php foreach ($acf_levels as $level_key => $level_value):
                                                    ...
                                                    if ($has_value): ?>
                                                        <div
                                                            class="swiper-slide slide-product-id-<?php echo $product_id; ?> pt__option__item <?php echo esc_html($level_value); ?>">
                                                            <div class="pt__item">
